...
const heroIntentLabel = document.querySelector("#hero-intent");
const heroStatusList = document.querySelector("#hero-statuses");
const enemyTrackers = document.querySelector("#enemy-trackers");
const modeSandboxButton = document.querySelector("#mode-sandbox");
